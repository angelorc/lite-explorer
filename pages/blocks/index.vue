        ...
        <v-row>
          <v-col cols="12" md="6">
            <div class="subtitle-2 mt-1">
              Block #{{
            blocks.docs[blocks.docs.length - 1].height
              }}
              to #{{ blocks.docs[0].height }} (Total of
              {{ blocks.totalDocs }} blocks)
            </div>
          </v-col>
          <v-col
            cols="12"
            md="6"
            :class="{'text-right': $vuetify.breakpoint.mdAndUp, 'text-center pt-0':$vuetify.breakpoint.smAndDown}"
          >
            <pagination
              :pagination-info="{
